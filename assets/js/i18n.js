...
const DICTS = {
  ...
  // ===== RSI texts for RSI settings page =====
const RSI_DICT = {
  en: {
    main: "RSI reversal signals",
    cross: "Level crossings",
    cross_hint: "Work with overbought / oversold zones and 50-level crossings.",
    extrema: "Catch minimum & maximum",
    extrema_hint: "Detect strong local reversals with adaptive window and delta.",
    strategy: "Strategy",
    rsi_len: "RSI length",
    zones: "Zones",
    cross50: "Cross 50",
    ...
    both: "Long + Short",
    z_none: "no limits",
    c_long: "Long (bottom→top)",
    c_short: "Short (top→bottom)",
    c_both: "Long + Short",
    save: "Save settings",
    note: "Switches are saved on this device and applied instantly.",
    save_toast: "RSI settings saved.",
  },
  hi: {
    main: "RSI रिवर्सल सिग्नल",
    cross: "लेवल क्रॉसिंग",
    cross_hint: "ओवरबॉट / ओवरसोल्ड ज़ोन और 50-लेवल क्रॉस के साथ काम करें।",
    extrema: "न्यूनतम और अधिकतम पकड़ें",
    extrema_hint: "अनुकूली विंडो और डेल्टा से मजबूत लोकल रिवर्सल पकड़ें।",
    strategy: "रणनीति",
    rsi_len: "RSI अवधि",
    zones: "ज़ोन",
    cross50: "50 का क्रॉस",
    ...
    short: "शॉर्ट",
    both: "लॉन्ग + शॉर्ट",
    z_none: "बिना सीमाओं के",
    c_long: "लॉन्ग (नीचे→ऊपर)",
    c_short: "शॉर्ट (ऊपर→नीचे)",
    c_both: "लॉन्ग + शॉर्ट",
    save: "सेटिंग्स सहेजें",
    note: "स्विच इस डिवाइस पर सहेजे जाते हैं और तुरंत लागू हो जाते हैं।",
    save_toast: "RSI सेटिंग्स सहेजी गईं।",
  },
  ru: {
    main: "Сигналы разворота по RSI",
    cross: "Пересечения уровней",
    cross_hint: "Работа с зонами перекупленности / перепроданности и пересечениями уровня 50.",
    extrema: "Поиск локальных минимумов и максимумов",
    extrema_hint: "Отлавливаем сильные локальные развороты по окну и дельте.",
    strategy: "Стратегия",
    rsi_len: "Период RSI",
    zones: "Зоны",
    ...
    note: "Переключатели сохраняются на этом устройстве и вступают в силу сразу.",
    save_toast: "Настройки RSI сохранены.",
  },
  pt: {
    main: "Sinais de reversão do RSI",
    cross: "Cruzamentos de nível",
    cross_hint: "Trabalhe com zonas de sobrecompra / sobrevenda e cortes no nível 50.",
    extrema: "Capturar mínimo e máximo",
    extrema_hint: "Detecte reversões locais fortes com janela e delta adaptativas.",
    strategy: "Estratégia",
    rsi_len: "Período do RSI",
    zones: "Zonas",
    cross50: "Cruzamento de 50",
    ...
    both: "Long + Short",
    z_none: "sem limites",
    c_long: "Long (baixo→cima)",
    c_short: "Short (cima→baixo)",
    c_both: "Long + Short",
    save: "Salvar configurações",
    note: "Os interruptores são salvos neste dispositivo e entram em vigor imediatamente.",
    save_toast: "Configurações de RSI salvas.",
  },
  es: {
    main: "Señales de giro del RSI",
    cross: "Cruces de nivel",
    cross_hint: "Trabaja con zonas de sobrecompra / sobreventa y cruces del nivel 50.",
    extrema: "Capturar mínimo y máximo",
    extrema_hint: "Detecta fuertes giros locales con ventana y delta adaptativas.",
    strategy: "Estrategia",
    rsi_len: "Periodo del RSI",
    zones: "Zonas",
    cross50: "Cruce de 50",
    ...
    both: "Largo + corto",
    z_none: "sin límites",
    c_long: "Largo (de abajo→arriba)",
    c_short: "Corto (de arriba→abajo)",
    c_both: "Largo + corto",
    save: "Guardar ajustes",
    note: "Los interruptores se guardan en este dispositivo y se aplican al instante.",
    save_toast: "Ajustes de RSI guardados.",
  },
  uk: {
    main: "Сигнали розвороту за RSI",
    cross: "Перетин рівнів",
    cross_hint: "Робота з зонами перекупленості / перепроданості та перетинами рівня 50.",
    extrema: "Пошук локальних мінімумів і максимумів",
    extrema_hint: "Виявляємо сильні локальні розвороти за вікном та дельтою.",
    strategy: "Стратегія",
    rsi_len: "Період RSI",
    zones: "Зони",
    cross50: "Перетин 50",
    window: "Вікно спостереження",
    in_delta: "Дельта",
    ...
    both: "Лонг + Шорт",
    z_none: "без меж",
    c_long: "Лонг (знизу→вгору)",
    c_short: "Шорт (згори→вниз)",
    c_both: "Лонг + Шорт",
    save: "Зберегти налаштування",
    note: "Перемикачі зберігаються на цьому пристрої та набувають чинності одразу.",
    save_toast: "Налаштування RSI збережено.",
  },
  de: {
    main: "RSI-Umkehrsignale",
    cross: "Level-Durchbrüche",
    cross_hint: "Arbeiten Sie mit Überkauft-/Überverkauft-Zonen und Durchbrüchen der 50er-Linie.",
    extrema: "Lokale Tiefs und Hochs finden",
    extrema_hint: "Starke lokale Umkehrpunkte mit adaptivem Fenster und Delta erkennen.",
    strategy: "Strategie",
    rsi_len: "RSI-Periode",
    zones: "Zonen",
    cross50: "Schnitt bei 50",
    ...
    both: "Long + Short",
    z_none: "ohne Grenzen",
    c_long: "Long (unten→oben)",
    c_short: "Short (oben→unten)",
    c_both: "Long + Short",
    save: "Einstellungen speichern",
    note: "Schalter werden auf diesem Gerät gespeichert und sofort wirksam.",
    save_toast: "RSI-Einstellungen gespeichert.",
  },
  fr: {
    main: "Signaux de retournement RSI",
    cross: "Franchissements de niveaux",
    cross_hint: "Travail sur les zones de surachat / survente et les franchissements du niveau 50.",
    extrema: "Repérer minimum et maximum locaux",
    extrema_hint: "Détecter de forts retournements locaux avec fenêtre et delta adaptatives.",
    strategy: "Stratégie",
    rsi_len: "Période du RSI",
    zones: "Zones",
    cross50: "Croisement de 50",
    ...
    both: "Long + Short",
    z_none: "sans limites",
    c_long: "Long (bas→haut)",
    c_short: "Short (haut→bas)",
    c_both: "Long + Short",
    save: "Enregistrer les paramètres",
    note: "Les interrupteurs sont enregistrés sur cet appareil et s’appliquent immédiatement.",
    save_toast: "Paramètres RSI enregistrés.",
  },
  it: {
    main: "Segnali di inversione RSI",
    cross: "Incroci di livello",
    cross_hint: "Lavora con le zone di ipercomprato / ipervenduto e i tagli della soglia 50.",
    extrema: "Catturare minimo e massimo locali",
    extrema_hint: "Individua forti inversioni locali con finestra e delta adattive.",
    strategy: "Strategia",
    rsi_len: "Periodo RSI",
    zones: "Zone",
    cross50: "Incrocio a 50",
    ...
    both: "Long + Short",
    z_none: "senza limiti",
    c_long: "Long (dal basso→in alto)",
    c_short: "Short (dall’alto→in basso)",
    c_both: "Long + Short",
    save: "Salva impostazioni",
    note: "Gli interruttori vengono salvati su questo dispositivo e hanno effetto immediato.",
    save_toast: "Impostazioni RSI salvate.",
  },
  ja: {
    main: "RSI 反転シグナル",
    cross: "レベルのクロス",
    cross_hint: "買われ過ぎ・売られ過ぎゾーンと 50 ラインのクロスで判断します。",
    extrema: "局所的な最安値・最高値を捉える",
    extrema_hint: "ウィンドウとデルタを使って強いローカル反転を検出します。",
    strategy: "ストラテジー",
    rsi_len: "RSI 期間",
    zones: "ゾーン",
    cross50: "50 のクロス",
    ...
    c_both: "ロング + ショート",
    save: "設定を保存",
    note: "スイッチはこのデバイスに保存され、すぐに適用されます。",
    save_toast: "RSI 設定を保存しました。",
  },
  tr: {
    main: "RSI dönüş sinyalleri",
    cross: "Seviye kesişimleri",
    cross_hint: "Aşırı alım / aşırı satım bölgeleri ve 50 seviye kesişimleri ile çalışır.",
    extrema: "Yerel dip ve tepeleri yakala",
    extrema_hint: "Uyarlanabilir pencere ve delta ile güçlü yerel dönüşleri tespit et.",
    strategy: "Strateji",
    rsi_len: "RSI periyodu",
    zones: "Bölgeler",
    cross50: "50 kesişimi",
    ...
    both: "Long + Short",
    z_none: "sınırsız",
    c_long: "Long (aşağıdan→yukarı)",
    c_short: "Short (yukarıdan→aşağı)",
    c_both: "Long + Short",
    save: "Ayarları kaydet",
    note: "Anahtarlar bu cihazda saklanır ve anında geçerli olur.",
    save_toast: "RSI ayarları kaydedildi.",
  },
  zh: {
    main: "RSI 反转信号",
    cross: "水平突破",
    cross_hint: "结合超买 / 超卖区域和 50 轴突破来判断。",
    extrema: "捕捉局部高点和低点",
    extrema_hint: "通过自适应窗口和 Delta 识别强烈的局部反转。",
    strategy: "策略",
    rsi_len: "RSI 周期",
    zones: "区域",
    cross50: "50 轴突破",
    ...
    save: "保存设置",
    note: "开关保存在本设备中并立即生效。",
    save_toast: "RSI 设置已保存。",
  },
};

Object.keys(RSI_DICT).forEach(function (lang) {
  if (!DICTS[lang]) return;
  DICTS[lang].rsi = RSI_DICT[lang];
});
